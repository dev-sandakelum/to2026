...
<div class="settings-overlay" id="settings-overlay">
  ...
  // --- Wire up all [data-settings-open] buttons (already in HTML) ---
  // settings.js no longer injects buttons — they are in the HTML markup.

  // Also wire up any dynamically-added drawer settings button for legacy support
  const drawerFooter = document.querySelector('.nav-drawer-footer');
  // (drawer settings button is already in HTML markup, no injection needed)
