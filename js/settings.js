...
<div class="settings-overlay" id="settings-overlay">
  ...
  // Place it inside .nav-actions, before the hamburger (.nav-toggle)
  const navToggle = document.querySelector('.nav-actions .nav-toggle');
  if (navToggle) {
    ...
    navToggle.insertAdjacentElement('beforebegin', settingsBtn);
  }
